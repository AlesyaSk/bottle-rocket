...
const ListView: React.FunctionComponent<ListViewComponentProps> = ({restaurantsList, clickHandler}: ListViewComponentProps) => {
    ...
    return (
        <RestaurantsList>
           ...
           restaurantsList.map((restaurant: any) =>
                   ...
                   category={restaurant.category} key={restaurant.name}
